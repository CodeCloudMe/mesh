(function() {
  var BuilderFactory, Builders, ChainBuilder, Config, RefBuilder, ScriptBuilder, SearchBuilder, ShellBuilder, TargetBuilder, crc32, fs, outcome, path, step, traverse, _;
