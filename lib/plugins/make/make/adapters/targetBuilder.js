(function() {
  var BaseBuilder, ShellBuilder, async, exec, handlebars,
  ...
  */
  ...
  module.exports = ShellBuilder = (function(_super) {
    ...
    */
    ...
    ShellBuilder.prototype.start = function(target, callback) {};

    /*
    */

    ShellBuilder.prototype.buildMessage = function(target) {
    ...
    */
    ...
    ShellBuilder.prototype._cmd = function(target) {
      return handlebars.compile(this.exec)(target.options);
    };
