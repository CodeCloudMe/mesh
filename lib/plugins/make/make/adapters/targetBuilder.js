  ...
  */
  ...
  module.exports = TargetBuilder = (function(_super) {
    ...
    */
    ...
    TargetBuilder.prototype.load = function(options) {
      this.options = options;
      return this.builder = this.builders.factory.newBuilder(null, this.options.build);
    };
