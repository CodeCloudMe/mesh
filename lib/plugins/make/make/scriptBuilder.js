  ...
  */
  ...
  module.exports = ScriptBuilder = (function(_super) {
    ...
    */
    ...
    ScriptBuilder.prototype.start = function(target, callback) {
    ...
    */
    ...
    ScriptBuilder.prototype.buildMessage = function(target) {
      if (this.builder.buildMessage) {
        return this.builder.buildMessage(target);
      } else {
        return ScriptBuilder.__super__.buildMessage.call(this, target);
      }
    };
