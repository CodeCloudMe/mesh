(function() {
  var async, copyDir, copyFile, copyFile2, copyMergeable, copyr, fs, merge, mkdirp, ncp, outcome, path, readMeshConfig, readPackageConfig, rmdirr, step, _;
