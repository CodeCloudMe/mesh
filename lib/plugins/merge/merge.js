(function() {
  ...
  module.exports = merge = function(ops, callback) {
    ...
    return step.async(function() {
      ...
      return mergeDirs(sourceDir, [platform]).filterFile(/\.merge\.json/, mergeDirs.mergeJSON(".json")).filterFile(/package\.json/, mergeDirs.mergeJSON("package.json", appPkg)).filterFile(mergeDirs.parseTemplate({})).join(outputDir).complete(this);
    }), res.success(function() {
      var deps;
