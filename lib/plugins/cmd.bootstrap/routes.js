    ...
    return router.on({
      ...
      */
      "pull v/output -> platforms -> copy/platforms": function(req, res, mw) {
        var copyFiles, copyPlatform, dir, output, platforms, toCopy, _i, _len, _ref;
        ...
        return step(function() {
          ...
          dir = toCopy.shift();
          return ncp(dir, "" + output + "/" + (path.basename(dir)), res.success(function() {
      ...
      */
      "pull platform/dirs -> platforms": function(req, res, mw) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (_.intersection(platforms, dirParts).length) {
